...
export const translations = {
  bn: {
    ...
    fee_type: 'ফি-র ধরণ',
    amount: 'টাকার পরিমাণ',
    manage_enrollments: 'ভর্তি ম্যানেজ করুন',
    new_batch: 'নতুন ব্যাচ',
    student_overrides: 'ছাত্র ফি ওভাররাইড',
    fee_generation: 'ফি জেনারেশন',
    generate_fees: 'ফি জেনারেট করুন',
    coaching: 'কোচিং',
    description: 'বিবরণ',
    select_student: 'ছাত্র নির্বাচন করুন',
    custom_amount: 'কাস্টম পরিমাণ',
    discount_percentage: 'ডিসকাউন্ট (%)',
    save_override: 'ওভাররাইড সংরক্ষণ করুন',
    collection: 'ফি সংগ্রহ',
    search_student: 'ছাত্র খুঁজুন',
    collect_payment: 'পেমেন্ট গ্রহণ করুন',
    payment_amount: 'পেমেন্টের পরিমাণ',
    total_due: 'মোট বকেয়া',
    record_payment: 'পেমেন্ট রেকর্ড করুন',
    payment_history: 'পেমেন্ট ইতিহাস',
    no_fees_found: 'কোনো ফি পাওয়া যায়নি',
    partial: 'আংশিক',
    paid: 'পরিশোধিত',
    unpaid: 'অপরিশোধিত'
  },
  en: {
    ...
    new_batch: 'New Batch',
    student_overrides: 'Student Fee Overrides',
