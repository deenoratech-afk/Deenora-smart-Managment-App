...
const App: React.FC = () => {
  ...
  const getViewFromPath = (path: string): View => {
    ...
    if (path === '/coaching') return 'coaching';
    if (path === '/fee-categories') return 'fee-categories';
    return 'home';
  };
  ...
  return (
    <Layout currentView={currentView} setView={(v) => {
      ...
      else if (v === 'coaching') navigate('/coaching');
      else if (v === 'fee-categories') navigate('/fee-categories');
      ...
      <Routes>
        ...
        <Route path="/coaching" element={<Coaching lang={lang} madrasah={madrasah} onBack={() => navigate('/')} role={role} />} />
        <Route path="/fee-categories" element={<FeeCategories lang={lang} madrasah={madrasah} onBack={() => navigate('/accounting')} />} />
